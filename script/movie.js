...
const getTopRatedMovies = async () => {
  try {
    ...
    const res = await fetch(
      "https://api.themoviedb.org/3/movie/569094?language=en-US&api_key=b677af115f50809f8c2e74edbbea0b1a",
      options
    );
    return res.json();
  } catch (err) {
...
const getcredit = async () => {
  try {
    const res = await fetch(
      "https://api.themoviedb.org/3/movie/569094/credits?language=en-US&api_key=b677af115f50809f8c2e74edbbea0b1a",
      options
    );
    return res.json();
  } catch (err) {
